export default {
    ...
    'abouttitle':'  您好，我是一位軟體工程師，有八年的軟體開發經驗包括DevOps、後端、網頁前端、Windows桌面程式。有後端重構的經驗，需求分析，維持Code乾淨易讀且有最好的效能，喜愛學習與提升自我的技能',
    'personaltraits':'個人特質',
    'personaltraitslist':'創意創新、洞察力、團隊合作、善良、勇敢、平易近人',
    'learntube':'能力提升學習管道',
